...
def wrap_session_description(
    ...
    if session_description is not None:
        return RTCSessionDescription(
            sdp=str(session_description), type=session_description.type, topic=session_description.topic
        )
    return None
...
class RTCPeerConnection(AsyncIOEventEmitter):
    ...
    def addTrack(self, track: None) -> RTCRtpSender:
        """
    ...
    def addTransceiver(self, trackOrKind: Union[str, None], direction: str = "sendrecv") -> RTCRtpTransceiver:
        """
    ...
    async def createAnswer(self, topic):
        """
    ...
    async def createOffer(self, topic) -> RTCSessionDescription:
        """
    ...
    def __assertTrackHasNoSender(self, track: None) -> None:

...
if __name__ == '__main__':
    ...
    parser.add_argument('--topic', '-t', help='Topic name', default='topic1')
    parser.add_argument('--stun', '-n', help='stun', default='stun.l.google.com:19302')
    args = parser.parse_args()

    if args.use_web_signal:
        signal_server = WebSignaling(args.source_name, args.signal_send_url, args.signal_receive_url, args.topic)
    else:
        signal_server = ConsoleSignaling(args.source_name)
    client = TunnelClient('', args.source_port, args.destination_port, signal_server, args.destination_name, args.topic, args.stun)
